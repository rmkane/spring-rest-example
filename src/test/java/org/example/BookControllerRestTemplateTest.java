...
public class BookControllerRestTemplateTest {
  ...
  @MockBean private BookRepository mockRepository;
  ...
  public void update_book_OK() throws Exception {
    ...
    ResponseEntity<String> response =
        restTemplate.exchange("/books/1", HttpMethod.PUT, entity, String.class);
  ...
  public void patch_bookPrice_405() throws JSONException {
    ...
    String expected =
        "{status:405,error:\"Method Not Allowed\",message:\"Field [price] update is not allowed.\"}";
    ...
    ResponseEntity<String> response =
        restTemplate.exchange("/books/1", HttpMethod.PATCH, entity, String.class);
  ...
  public void delete_book_OK() {
    ...
    ResponseEntity<String> response =
        restTemplate.exchange("/books/1", HttpMethod.DELETE, entity, String.class);
